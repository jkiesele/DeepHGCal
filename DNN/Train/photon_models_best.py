...
def photonModel2(Inputs,nclasses,nregressions,dropoutRate=0.05,momentum=0.6):
    ...
    x=Convolution3D(8,kernel_size=(2,2,5),strides=(2,2,5), #padding='same',
                    activation='relu',kernel_initializer='lecun_uniform')(x)
    
    x=Convolution3D(20,kernel_size=(4,4,4),strides=(1,1,1), #padding='same',
                    activation='relu',kernel_initializer='lecun_uniform')(x)
    x=BatchNormalization(momentum=momentum)(x)
    ...
    #x=BatchNormalization(momentum=momentum)(x)
    x = Dropout(dropoutRate)(x)
    x = Dense(64, activation='relu',kernel_initializer='lecun_uniform')(merged)
    #x=BatchNormalization(momentum=momentum)(x)
...
def photonModel(Inputs,nclasses,nregressions,dropoutRate=0.05,momentum=0.6):
    ...
    x=Convolution3D(4,kernel_size=(3,3,6),strides=(1,1,2), padding='same',activation='linear',kernel_initializer='lecun_uniform')(x)
    x=BatchNormalization(momentum=momentum)(x)
    x = Dropout(dropoutRate)(x)
    x=Convolution3D(4,kernel_size=(3,3,6),strides=(2,2,4), padding='same',activation='linear',kernel_initializer='lecun_uniform')(x)
    x=BatchNormalization(momentum=momentum)(x)
    x = Dropout(dropoutRate)(x)
    x=Convolution3D(4,kernel_size=(4,4,6),strides=(3,3,3), padding='same',activation='linear',kernel_initializer='lecun_uniform')(x)
    x=BatchNormalization(momentum=momentum)(x)
    x = Dropout(dropoutRate)(x)
    x=Convolution3D(4,kernel_size=(1,1,1), padding='same', activation='linear',kernel_initializer='lecun_uniform')(x)
    x=BatchNormalization(momentum=momentum)(x)
    x = Dropout(dropoutRate)(x)
    ...
    x = Dense(150, activation='relu',kernel_initializer='lecun_uniform')(merged)
    #x=BatchNormalization(momentum=momentum)(x)
    x = Dropout(dropoutRate)(x)
    x = Dense(64, activation='relu',kernel_initializer='lecun_uniform')(merged)
    #x=BatchNormalization(momentum=momentum)(x)
...
if not train.modelSet():
    ...
    train.setModel(photonModel2,dropoutRate=0.05,momentum=0.6)
