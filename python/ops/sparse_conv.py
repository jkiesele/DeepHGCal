...
def sparse_conv_2(all_features, space_features, indexing_tensor, output_all=15, weight_init_width=1e-4,
...
def sparse_max_pool_2(pooling_features, num_entries_result, graphs):
