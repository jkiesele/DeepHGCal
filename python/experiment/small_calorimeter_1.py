...
if __name__ =="__main__":
    if len(sys.argv) < 2:
        print("Usage: python bin/experiment path/to/root_file.root")
        exit()
    ...
    n_entires = len(root_numpy.root2array(file, branches=['isElectron'], treename=treename)['isElectron'])
