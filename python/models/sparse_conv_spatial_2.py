...
class SparseConvSpatial2(SparseConv):

    def __init__(self, n_space, n_space_local, n_all, n_max_neighbors, batch_size, max_entries, num_classes,
                 learning_rate=0.0001):
        super(SparseConvSpatial2, self).__init__(n_space, n_space_local, n_all, n_max_neighbors, batch_size, max_entries,
    ...
    def _find_logits(self):
        ...
        net = sparse_conv_make_neighbors(_input, num_neighbors=18, output_all=15)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=15)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=15)
        net = sparse_max_pool(net, 600)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=30)
        net = sparse_max_pool(net, 150)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=10)
