...
class SparseConvSpatial3(SparseConv):

    def __init__(self, n_space, n_space_local, n_all, n_max_neighbors, batch_size, max_entries, num_classes,
                 learning_rate=0.0001):
        super(SparseConvSpatial3, self).__init__(n_space, n_space_local, n_all, n_max_neighbors, batch_size, max_entries,
    ...
    def _find_logits(self):
        ...
        net = sparse_conv_make_neighbors(_input, num_neighbors=18, output_all=15, propagrate_ahead=True, spatial_degree_non_linearity=2)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=15, propagrate_ahead=True, spatial_degree_non_linearity=2)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=15, propagrate_ahead=True, spatial_degree_non_linearity=2)
        net = sparse_max_pool(net, 600)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=30, propagrate_ahead=True, spatial_degree_non_linearity=2)
        net = sparse_max_pool(net, 150)
        net = sparse_conv_make_neighbors(net, num_neighbors=18, output_all=10, propagrate_ahead=True, spatial_degree_non_linearity=2)
    ...
    def get_variable_scope(self):
        return 'sparse_conv_spatial_normal'
