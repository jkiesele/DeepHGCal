...
void NTupleRecHits::initDNNBranches(TTree* t){
	...
	addBranch(t,add+"rechit_eta",   &rechit_eta_);
	addBranch(t,add+"rechit_phi",   &rechit_phi_);
//	addBranch(t,add+"rechit_a",   &rechit_a_);
//	addBranch(t,add+"rechit_b",   &rechit_b_);
	addBranch(t,add+"rechit_x",   &rechit_x_);
	addBranch(t,add+"rechit_y",   &rechit_y_);
	addBranch(t,add+"rechit_z",   &rechit_z_);
	addBranch(t,add+"rechit_energy",&rechit_energy_);
//	addBranch(t,add+"rechit_time"  ,&rechit_time_);
	addBranch(t,add+"rechit_layer"  ,&rechit_layer_);
//	addBranch(t,add+"rechit_total_fraction"  ,&rechit_total_fraction_ );
